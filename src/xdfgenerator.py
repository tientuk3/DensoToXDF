...
def generate_xdf(in_file: str, out_file: str, map_data_offset: int):
    ...
    in_file_size = os.path.getsize(filename=filename)
    f = open(filename, "rb")
    ...
    f_out.writelines([  "<XDFFORMAT version=\"1.70\">\n"
                        ...
                        "    <REGION type=\"0xFFFFFFFF\" startaddress=\"0x0\" size=\"" + hex(in_file_size) + "\" regionflags=\"0x0\" name=\"Binary File\" desc=\"This region describes the bin file edited by this XDF\" />\n",
                        "  </XDFHEADER>\n"
                    ] )
